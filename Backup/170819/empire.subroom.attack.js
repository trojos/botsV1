...
var subroomattack = {
    run: function (room, subroom, wait) {
        ...
        //----------Nahkampf-----------
        if (!wait) {
            var nahdd = 6           //Regelanzahl  (teils angriff, teils warten, daher ca. das doppelte das gleichzeitig angreifen soll)
