...
function createSammelpunkt(SPorigin,SPdest) {
    ...
    run: function (targetroom) {
        ...
        if (arAlle.length == 0) {
            ...
            if (Memory.Attack[targetroom].Sammelpunkt == undefined || Memory.Attack[targetroom].Sammelpunkt == '') {
                ...
                createSammelpunkt(SPorigin,SPdest)
            ...
            if (insight) {                                  //<---------- Anzahl der Creeps die für einen Angriff erforderlich sind
                ...
                if (hostile.length < 1) {
                    //sammeln:
                    var mcNahDD = 0
                    var mcFernDD = 0                        //Wenn Raumsicht und keine feindlichen Creeps dann andere Anzahl
                    var mcHeiler = 0
                    //im Kampf:
                    var fcNahDD = 5
                    var fcFernDD = 5
