...
var empireroom = {
    run: function (room, subrooms) {
        ...
        if (Memory.rooms[room].Bmstr.constructionsites != bmstrsites.length || Memory.rooms[room].Bmstr.tick < Game.time - 510) {
            Memory.Bmstr = {}
        ...
        if (tellenergy) {
            ...
            if (energyneed.length < 20) {       //Wenn viele Objekte Energie brauchen wird Terminal nicht beliefert damit die anderen schneller geladen werden
