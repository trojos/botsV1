...
var subroom = {
    run: function (room, subroom, wait) {
                ...
                if (insight) {
                    ...
                    sources.forEach(function (spot) {
                        ...
                        if (lairbyspot.length > 0 || spot.length > 0) {
                            ...
                            new RoomVisual(subroom).circle(waitpoint.x, waitpoint.y, { fill: '#ff0000', radius: .5 })
                            if (waitpoint) {
                                Memory.rooms[subroom].spots[spot.id].waitpoint = waitpoint
                            } else {
                                Memory.rooms[subroom].spots[spot.id].waitpoint = spot.pos
                            }
                        }
        ...
        if (maxenergy >= 5600 && !center) {
            ...
            if (maxenergy >= 6300) {
                var cbody = [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, HEAL, HEAL, HEAL, HEAL, HEAL]
            } else {
